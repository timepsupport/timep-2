...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use this generator?" text3="Create stunning tips for more efficient studies." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                ></motion.p>
                    Our AI understands what's the secrets to keep your learnig more fun and efficient.
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Boost your studies with AI-optimized tips. </h3>
                        <p className="text-slate-300 mt-2"> Stop guessing and start ranking. Our AI creates tips proven for long-term learning. </p>
