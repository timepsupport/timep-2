...
export default function PricingSection() {
    return (
        <div id="pricing" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Use Cases" text2="Smart learning solutions" text3="Flexible learning tools designed to match your academic journey — whether you're preparing exams, teaching, or collaborating." />
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 mt-20">
                {pricingData.map((plan: IPricing, index: number) => (
                    ...
                    >
                        ...
                        <p className="text-pink-400 font-medium text-sm mt-1">{plan.period}</p>
